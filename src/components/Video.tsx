...
export function Video({ videoId }: Readonly<VideoProps>) {
  ...
  return (
    <Container>
      <div className="relative w-full h-[500px] max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl bg-range-300 cursor-pointer bg-gradient-to-tr from-orange-400 to-orange-700">
        {!playVideo && (
          <button
